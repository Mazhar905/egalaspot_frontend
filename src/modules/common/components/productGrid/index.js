          ...
          {products.length > 0 &&
            products
              .slice(
                ...
                productPagination.offset + productPagination.limit
              )
              ?.map((product, index) => {
                return (
                  <ProductCard
            ...
            <ul className="flex space-x-2">
              ...
              {currentPage > 1 && (
                <li
                  ...
                  className="flex items-center justify-center flex-shrink-0 border border-red-500 !text-red-500 cursor-pointer text-base font-bold w-10 h-10 rounded-full"
                >
                  {currentPage - 1}
                </li>
              )}
              ...
              <li
                ...
                className="flex items-center justify-center flex-shrink-0 bg-orange-500 border-2 border-orange-500 cursor-pointer text-base font-bold text-white w-10 h-10 rounded-full"
              >
                {currentPage}
              </li>
